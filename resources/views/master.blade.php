...
<html lang="en">
  ...
  <body>
    <div class="p-5 bg-info text-white">
      <a href="{{route('notes.all')}}" class="btn btn-secondary">Home</a>
      @auth
      <a href="{{route('notes.index')}}" class="btn btn-secondary">Your posts</a>
      @endauth
      <a href="{{route('notes.create')}}" class="btn btn-secondary">create</a>
    @auth
